...
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_cube" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_happyhouse" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_nice" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_sus" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_chad" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_jimball" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_krustytheclown" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_blurred" end
if Cryptid.enabled["Misc. Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_filler" end
if Cryptid.enabled["M Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_reverse" end --uno reverse
if Cryptid.enabled["M Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_bonk" end
if Cryptid.enabled["Epic Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_boredom" end
if Cryptid.enabled["Epic Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_curse" end
if Cryptid.enabled["Epic Jokers"] then Cryptid.memepack[#Cryptid.memepack+1] = "j_cry_m" end
