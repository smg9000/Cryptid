...
local spaghetti = {
	...
	if G.P_CENTERS.j_evo_full_sugar_cola then jokers[#jokers+1] = "j_evo_full_sugar_cola" end
	if G.P_CENTERS.j_bunc_starfruit then jokers[#jokers+1] = "j_bunc_starfruit" end
	if G.P_CENTERS.j_bunc_fondue then jokers[#jokers+1] = "j_bunc_fondue" end
	if G.P_CENTERS.j_kcva_fortunecookie then jokers[#jokers+1] = "j_kcva_fortunecookie" end
	if G.P_CENTERS.j_kcva_swiss then jokers[#jokers+1] = "j_kcva_swiss" end
	if G.P_CENTERS.j_olab_taliaferro then jokers[#jokers+1] = "j_olab_taliaferro" end
	if G.P_CENTERS.j_olab_royal_gala then jokers[#jokers+1] = "j_olab_royal_gala" end
	if G.P_CENTERS.j_olab_fine_wine then jokers[#jokers+1] = "j_olab_fine_wine" end
	if G.P_CENTERS.j_olab_mystery_soda then jokers[#jokers+1] = "j_olab_mystery_soda" end
	if G.P_CENTERS.j_olab_popcorn_bag then jokers[#jokers+1] = "j_olab_popcorn_bag" end
	if G.P_CENTERS.j_snow_turkey_dinner then jokers[#jokers+1] = "j_snow_turkey_dinner" end
	if G.P_CENTERS.j_ssj_coffee then jokers[#jokers+1] = "j_ssj_coffee" end
	if G.P_CENTERS.j_twewy_candleService then jokers[#jokers+1] = "j_twewy_candleService" end
	if G.P_CENTERS.j_twewy_burningCherry then jokers[#jokers+1] = "j_twewy_burningCherry" end
	if G.P_CENTERS.j_twewy_burningMelon then jokers[#jokers+1] = "j_twewy_burningMelon" end
	if G.P_CENTERS.j_pape_soft_taco then jokers[#jokers+1] = "j_pape_soft_taco" end
	if G.P_CENTERS.j_pape_crispy_taco then jokers[#jokers+1] = "j_pape_crispy_taco" end
	if G.P_CENTERS.j_pape_nachos then jokers[#jokers+1] = "j_pape_nachos" end
